...
local AceSerializer = APkg and APkg.tPackage or {}
...
-- Register Library
function AceSerializer:OnLoad() end
function AceSerializer:OnDependencyError(strDep, strError) return false end
Apollo.RegisterPackage(AceSerializer, MAJOR, MINOR, {})
